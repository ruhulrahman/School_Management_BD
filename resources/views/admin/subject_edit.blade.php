...
<style>
  ...
  table tr td{text-align: center !important;}
            ...
            <!-- END PAGE HEADER-->
            <a href="{{ asset('/subject-add') }}/{{ Session::get('AdminName') }}" class="btn btn-primary">Add New Subject</a><hr>
            <!-- BEGIN PAGE CONTENT-->
            <div class="row-fluid">
                <div class="span5">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="{{ url('/subject-update') }}" method="post" id="scl_form" class="form-horizontal">
                                {{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="subject_name_en" value="{{ $sub->subject_name_en }}" id="subject_name_en" placeholder="Enter subject name (English)" style="display: block;" class="input-large" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="subject_name_bn" class="control-label">Add New Subject Name (Bangla Version)</label>
                                    <div class="controls">
                                        <input type="text" name="subject_name_bn" value="{{ $sub->subject_name_bn }}" id="subject_name_bn" placeholder="Enter subject name (Bangla)" style="display: block;" class="input-large" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
